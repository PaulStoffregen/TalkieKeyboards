...
#define PS2KEYBOARD_BUFFER_SIZE 45
...
class PS2Keyboard {
  public:
     ...
     */
    void begin(uint8_t dataPin, uint8_t irq_pin, const PS2Keymap_t &map = PS2Keymap_US);
...
private:
	...
	friend void ps2key_isr0(void);
	friend void ps2key_isr1(void);
	friend void ps2key_isr2(void);
	friend void ps2key_isr3(void);
	friend void ps2key_isr4(void);
	friend void ps2key_isr5(void);
	friend void ps2key_isr6(void);
	friend void ps2key_isr7(void);

	volatile uint8_t buffer[PS2KEYBOARD_BUFFER_SIZE];
